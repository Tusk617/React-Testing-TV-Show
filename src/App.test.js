...
import { render, waitFor, userEvent, fireEvent} from "@testing-library/react";
import App from "./App";
...
test ("render episodes after season is selected", async () => {
        ...
        // expect(getAllByText(/season /)).toHaveLength(3);
